...
const authorRouter = require('./src/routes/authorRoutes')(Author);
const config = require('./config');

const app = express();
const port = process.env.PORT || 3000;
mongoose.connect("mongodb+srv://vikasch2802:Vikas2802@cluster0.gqqbujy.mongodb.net/Mini_Library_Management");
